...
export interface LevelSpec { id:string;number:number;title:string;subtitle:string;gravity:number;platforms:LevelPlatform[];receiver:LevelReceiver;initialParts:PartState[];initialSignals:SignalLink[];inventory:Readonly<Record<PartKind,number>>;maxRopes:number;maxHinges:number; }
export const LEVEL_07:LevelSpec={
 ...
 inventory:{ball:0,plank:3,wall:0,lever:1,pulley:1,weight:0,domino:6,rubberball:0,spring:1,magnet:0,sheave:2,motor:1,gear:3,conveyor:1,switch:1,button:0,latch:0},maxRopes:3,maxHinges:2
};
