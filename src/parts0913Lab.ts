...
import { createBoxingGloveModelV12 } from './boxingGloveV12';
...
const CONFIGS: Record<AssetKey0913, AssetConfig0913> = {
  'boxing-glove': {
    key: 'boxing-glove', part: '09', title: 'Boxing Glove', version: 'boxing-glove-v12',
    sourceLicense: 'CC-BY', sourceKey: 'sketchfab-incg5764-boxing-glove-cc-by', radius: 1.82,
    initialRotation: [-0.045, -0.48, 0.015], create: createBoxingGloveModelV12
  },
  trampoline: {
